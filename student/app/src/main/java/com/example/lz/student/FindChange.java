 ...
 */
public class FindChange extends BaseActivity implements View.OnClickListener{
    EditText find;
    Button btn;
    Studentdb studentdb;
    ...
    protected void getView() {
        ...
        find = (EditText) findViewById(R.id.change_et);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.change_btn:
                ...
                if (student!=null) {
                    Intent in =new Intent(this,ChangeInfo.class);
                    Bundle b=new Bundle();
                    b.putSerializable("change",student);
                    in.putExtras(b);
                    startActivity(in);
                }else {
