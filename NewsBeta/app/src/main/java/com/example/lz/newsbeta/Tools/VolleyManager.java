...
public class VolleyManager {
    ...
    public void jsonnetwork(String s){
        try {
            ...
            for (int i=0;i<dataarray.length();i++){
                ...
                getbitmap(joimg,jotitle,jourl,jodate,jotype,joimg);
            }
     ...
     * @param type
     */
    public void getbitmap(String url, final String name, final String newsurl, final String date, final String type, final String imgurl){
        ImageRequest imageRequest=new ImageRequest(url, new Response.Listener<Bitmap>() {
            @Override
            public void onResponse(Bitmap bitmap) {
                if (handImg!=null){
                    handImg.hand(bitmap,name,newsurl,date,type,imgurl);
                }
            }
    ...
    public interface HandImg{
        void hand(Bitmap bitmap,String name,String url,String date,String type,String imgurl);
    }
